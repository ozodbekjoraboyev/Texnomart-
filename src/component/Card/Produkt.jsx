...
//         </div>
//       </div>
//       <div className="  grid grid-cols-3 items-center m-auto gap-10 ">
//         <div className="m-auto flex items-center pt-16">
//           <div>
//             <div className=" overflow-y-auto gap-2  flex flex-col skrol h-[500px] ">
//               {produktalohoda.small_images.map((rasmlar) => {
//                 return (
//                   <div>
//                     <img className="w-20 h-40" src={rasmlar} alt="" />
//                   </div>
//                 );
//               })}
//             </div>
...
//               {produktalohoda.offers_by_image.map((itemRasm) => {
//                 return (
//                   <div>
//                     <img className="w-19" src={itemRasm.image} alt="" />
//                   </div>
//                 );
//               })}
//             </div>
...
//                 <p>
//                   {produktalohoda.minimal_loan_price.description.slice(0, 16)}
//                 </p>
...
//                 </button>
//                 <p>
//                   {produktalohoda.minimal_loan_price.month_number} /oy{" "}
...
//               />
//               <div>
//                 <p className=" ">Do'kondan olib ketish bepul </p>
//                 <p className=" text-blue-700">35 ta dokon mavjut</p>
//               </div>
//             </div>
...
function AlohidaCard() {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        setProdukt(res.data.data.data || {}); // Agar ma'lumot bo‘lmasa, bo‘sh obyekt saqlanadi
      })
